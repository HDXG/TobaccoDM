...
public class TobaccoDMInputAcceptanceHostModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.ApplicationName = TobaccoDMInputAcceptanceDomainOptions.ApplicationName;
        ...
        context.Services.AddSwaggerGen(options =>
        {
            ...
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "TobaccoDMInputAcceptance.MinimalApi.xml"), true);
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "TobaccoDMInputAcceptance.UseCase.xml"), true);
        });
